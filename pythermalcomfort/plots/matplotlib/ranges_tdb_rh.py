...
def ranges_tdb_rh(
    ...
    **kwargs: Any,
    ...
    """Plot comfort/risk ranges on a Temperature vs Relative Humidity chart.
    ...
    ----------
    model_func : Callable[..., Any]
        The comfort model function to evaluate. Must accept keyword arguments for
        tdb and rh among its parameters. Examples: pmv_ppd_iso, set_tmp,
        heat_index_rothfusz, utci.
    fixed_params : dict[str, Any] or None, optional
        Dictionary of model parameters to keep fixed for all evaluations (e.g.,
        tr, met, clo, vr, wme, p_atm). Required by most models.
    ...
    **kwargs : Any
    ...
    ...     title="Custom PMV Visualization",
    ...     figsize=(10, 6),
    ... )
    >>> plt.show()
    """
