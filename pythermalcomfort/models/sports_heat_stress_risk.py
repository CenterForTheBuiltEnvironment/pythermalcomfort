...
# todo check that the following values are correct and match the dictionary commented out below, if so deleted the dictionary
# it is okay that the sport name is missing, not needed for the calculations
...
# todo delete this dictionary if the dataclass above is correct
# sports_dict = {
#     "abseiling": {
#         "clo": 0.6,
#         "met": 6.0,
